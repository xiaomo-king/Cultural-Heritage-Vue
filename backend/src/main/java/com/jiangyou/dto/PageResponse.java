...
public class PageResponse<T> {
    ...
    public PageResponse() {}
    public PageResponse(List<T> list, int page, int size, long total) {
        this.list = list; this.page = page; this.size = size; this.total = total;
        this.totalPages = (int) Math.ceil((double) total / size);
    }
    public List<T> getList() { return list; } public void setList(List<T> list) { this.list = list; }
